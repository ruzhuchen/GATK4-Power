...
/usr/bin/time -v -o time_bwa.log taskset -c 0-159 bwa mem -t 160 -Ma \
     ...
     $ref $input1 $input2 | samtools view -bS - -@ 20 | samtools sort - -@ 40 -n -m 8G -T $input1 -o $output
...
/usr/bin/time -v -o time_Sort_mk.log taskset -c 0-159:4 samtools sort -@ 40 -m 8G -o sorted.bam fixmate.bam
